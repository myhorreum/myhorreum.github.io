...
* Installed ELK Stack components and fit them in accordance to the organization's firewall.
...
* Automated reporting by writing a bash script that receives a .csv from Kibana via a generated POST URL, waits for the .csv to fully download, the emails the .csv out to recipients.
