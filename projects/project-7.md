...
* Automated reporting by writing a bash script that receives a .csv from Kibana via a generated POST URL, waits for the .csv to fully download, then emails the .csv out to designated recipients. I create a [guide]({{ site.baseurl }}/projects/Reporting-Guide.pdf) outlining this process.
