...
Also here is the Logstash [config]({{ site.baseurl }}/projects/logstash-config.txt) file that I slowly built up over the time working here. The file grew to be more complex over time.
