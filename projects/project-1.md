...
## TIME COMPLEXITY?
I thought it would be interesting to comment on the [time-complexity](https://www.happycoders.eu/algorithms/big-o-notation-time-complexity/) of this slot machine implementation. This slot machine is evaluated as having a time complexity (in Big O Notation) of *O(1)* - or constant time. If you check the code you can see there are no for-loop iterations which would change the Big O evaluation. 
